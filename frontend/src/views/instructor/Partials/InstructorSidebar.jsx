...
function InstructorSidebar({ sidebarCollapsed }) {
  ...
  return (
    ...
    >
      ...
      <ul className="list-unstyled" style={{ padding: 0, margin: 0 }}>
        ...
        <li className="nav-item">
          <Link
            className={`nav-link ${isActive("/teacher/quiz") ? "active" : ""}`}
            to="/teacher/quiz"
            style={{
              display: "flex",
              alignItems: "center",
        ...
        <li className="nav-item">
          <Link
            className={`nav-link ${isActive("/teacher/messages") ? "active" : ""}`}
            to="/teacher/messages"
            style={{
              display: "flex",
              alignItems: "center",
      ...
      <ul className="list-unstyled" style={{ padding: 0, margin: 0, marginBottom: "10px" }}>
        <li className="nav-item">
          <Link
            className={`nav-link ${isActive("/teacher/settings") ? "active" : ""}`}
            to="/teacher/settings"
            style={{
              display: "flex",
              alignItems: "center",
