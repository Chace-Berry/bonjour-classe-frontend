...
const navItems = [
  { label: "Courses", icon: <i className="bi bi-book" />, path: "/student/courses" },
  { label: "Quizzes", icon: <i className="bi bi-question-circle" />, path: "/student/quiz" },
  { label: "Home", icon: <i className="bi bi-house" />, path: "/student/dashboard" },
  { label: "Messages", icon: <i className="bi bi-chat-dots" />, path: "/student/messages" },
];
...
const moreNav = [
  { label: "Assignments", icon: <i className="bi bi-pencil" />, path: "/student/assignments" },
  { label: "Settings", icon: <i className="bi bi-gear" />, path: "/student/settings" },
